import{i as z,e as G,r as q,a as A,b as c,C as M,A as D,O as Q,c as k,d as P,f as ve,E as te,R as U,g as qe,H as ri,h as K,S as wt,W as Fe,j as ae,k as xn,T as on,l as Ve,M as ai,m as si,w as Ue,n as $i,o as Cn,p as _i}from"./index-D8xGRD99.js";import{n as u,c as L,o as I,r as C,U as pe,e as Ei,f as Ii,a as Wi}from"./index-sQtjWpgT.js";import{g as Ti}from"./index-CMgM9bk4.js";const Si=z`
  :host {
    position: relative;
...
`;var bi=function(r,e,n,o){var i=arguments.length,t=i<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,n):o,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(r,e,n,o);else for(var s=r.length-1;s>=0;s--)(a=r[s])&&(t=(i<3?a(t):i>3?a(e,n,t):a(e,n))||t);return i>3&&t&&Object.defineProperty(e,n,t),t};let dt=class extends A{constructor(){super(...arguments),this.inputElementRef=gn(),this.checked=void 0}render(){return c`
    ...
    `}dispatchChangeEvent(){this.dispatchEvent(new CustomEvent("switchChange",{detail:this.inputElementRef.value?.checked,bubbles:!0,composed:!0}))}};dt.styles=[q,G,_i,So];bi([u({type:Boolean})],dt.prototype,"checked",void 0);dt=bi([L("wui-switch")],dt);const Bo=z`
  :host {
    height: 100%;
  }
